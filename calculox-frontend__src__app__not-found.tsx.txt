    ...
    <Suspense fallback={
      ...
      <div className="fixed inset-0 z-[100] bg-[#fafafa] flex min-h-screen w-full flex-col items-center justify-center overflow-hidden font-inter text-neutral-900">
        ...
        <div className="relative z-10 w-full max-w-4xl px-6 flex flex-col items-center">
          ...
          {/* 🚀 BUG FIX: Isolated Breadcrumb Layer with higher Z-Index */}
          <div className="relative z-30 mb-4 animate-fade-in pointer-events-auto">
            <Breadcrumbs 
              settings={settings} 
              data={{ is404: true }} 
              className="text-sm font-medium text-neutral-400 bg-transparent p-0 shadow-none border-none"
            />
          </div>

          {/* 🚀 BUG FIX: Kinetic Hero Section with isolated group-hover scope */}
          ...
          <div className="relative z-20 max-w-lg text-center mb-8">
              <h2 className="text-3xl font-bold text-neutral-900 mb-2 tracking-tight">You've reached a dead end.</h2>
              <p className="text-neutral-500 text-lg leading-relaxed">
                  The calculation or page you are looking for has been moved or doesn't exist. Let's get you back to the right tools.
              </p>
          </div>
